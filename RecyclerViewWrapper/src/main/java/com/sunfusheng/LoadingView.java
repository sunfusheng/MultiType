...
/**
 * @author sunfusheng on 2018/7/12.
 */
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaintColor = array.getColor(R.styleable.LoadingView_viewColor, Color.GRAY);
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_viewSize, dip2px(context, 30));
        array.recycle();
        initPaint();
    }
